...
namespace WirtualnyDziennik.Models
{
    public class NhibernateSession
    {
        ...
        {
            String connectionString = "User ID=PS2_NS_LP;Password=PS2_NS_LP;Data Source=(DESCRIPTION = (ADDRESS = (PROTOCOL = TCP)(HOST = 212.33.90.213)(PORT = 1521)) (CONNECT_DATA = (SERVER = DEDICATED) (SERVICE_NAME = XE)))";
